package dev.lukasgrigis.blog.rfc8693.review.controller;

import dev.lukasgrigis.blog.rfc8693.review.openapi.SecurityRequirementName;
...
public class DebugController {
    ...
    @Operation(
            ...
            description = "Endpoint to check if the caller has the required permissions (REVIEWER).",
            security = @SecurityRequirement(name = SecurityRequirementName.OIDC)
    )
