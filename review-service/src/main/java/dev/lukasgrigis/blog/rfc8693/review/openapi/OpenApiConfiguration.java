package dev.lukasgrigis.blog.rfc8693.review.openapi;
...
record OpenApiProperties(
        @NotBlank @DefaultValue("Review Service API") String name,
        @NotBlank @DefaultValue("Documentation for the Review Service API") String description,
