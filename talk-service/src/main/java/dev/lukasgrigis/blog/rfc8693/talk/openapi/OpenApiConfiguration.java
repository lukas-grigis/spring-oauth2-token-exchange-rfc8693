package dev.lukasgrigis.blog.rfc8693.talk.openapi;
...
record OpenApiProperties(
        @NotBlank @DefaultValue("Talk Service API") String name,
        @NotBlank @DefaultValue("Documentation for the Talk Service API") String description,
